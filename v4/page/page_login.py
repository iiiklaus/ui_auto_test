...
# from ..base.base_page import   BasePage,BaseHander

import untils
from v4.base.base_page import BasePage,BaseHander
...
class LoginProxy:
    ...
    def hander_login(self,username,password,verify_box):
        ...
        self.lo
        gin_operator.input_verify_code(verify_box)
